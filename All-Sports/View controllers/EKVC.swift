...
@objc(EKVC)
class EKVC: UITableViewController, EKEventEditViewDelegate {
...
//      let calendar = Calendar.current
      ...
      let endDate = Date(timeInterval: day, since: startDate as Date)
...
//            options: [])!
      ...
      let predicate = self.eventStore.predicateForEvents(withStart: startDate as Date,
                                                         end: endDate,
